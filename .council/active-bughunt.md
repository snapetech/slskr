...
crates/slskr/src/lib.rs:91601:    let mut actual = vec![0_u8; HEADER.len()];
...
crates/slskr/src/controller_tests.rs:19265:        record.results = vec![template.clone(); super::MAX_SEARCH_RESULTS_PER_SEARCH];
crates/slskr/src/controller_tests.rs:21691:        file.read_chunk(3).await.expect("chunk")
crates/slskr/src/controller_tests.rs:22067:        file.read_chunk(3).await.expect("chunk")
crates/slskr/src/controller_tests.rs:22172:        file.read_chunk(2).await.expect("chunk")
crates/slskr/src/controller_tests.rs:22258:        file.read_chunk(2).await.expect("chunk")
crates/slskr/src/controller_tests.rs:22423:    assert_eq!(file.read_chunk(2).await.expect("chunk"), vec![3, 4]);
crates/slskr/src/controller_tests.rs:24223:        record.members = vec![template.clone(); super::MAX_SHARE_GROUP_MEMBERS];
crates/slskr/src/controller_tests.rs:24385:        record.items = vec![template.clone(); super::MAX_COLLECTION_ITEMS];
crates/slskr/src/controller_tests.rs:28751:        let mut frame = Vec::with_capacity(4 + length as usize);
crates/slskr/src/controller_tests.rs:28866:            let mut actual = vec![0_u8; expected.len()];
crates/slskr/src/controller_tests.rs:103526:        vec![b' '; (super::MAX_TRANSFER_STATE_BYTES as usize) + 1],
crates/slskr/src/controller_tests.rs:103846:        vec![b' '; (super::MAX_TRANSFER_EVENTS_BYTES as usize) + 1],
crates/slskr/src/controller_tests.rs:103906:    let mut header = vec![0_u8; 42];
crates/slskr/src/controller_tests.rs:103948:    let mut header = vec![0_u8; 42];
crates/slskr/src/controller_tests.rs:104104:            let mut bytes = vec![0_u8; 65_536];
crates/slskr/src/controller_tests.rs:118220:        vec![0_u8; 64 * 1024 + 1],
crates/slskr/src/controller_tests.rs:120160:    let low = entropy.check(&vec![0_u8; EntropyControl::SAMPLE_SIZE]);
...
crates/slskr/src/controller_tests.rs:93858:            forwarded_port: Some(44_499),
crates/slskr/src/controller_tests.rs:93883:                && application["vpn"]["forwardedPort"] == 44_499
crates/slskr/src/controller_tests.rs:99372:        let client = reqwest::Client::new();
...
crates/slskr/src/lib.rs:89557:                let _ = fs::remove_file(path);
crates/slskr/src/lib.rs:91226:        match root.canonicalize() {
crates/slskr/src/lib.rs:91315:                let Ok(canonical_path) = path.canonicalize() else {
crates/slskr/src/lib.rs:91560:    fs::create_dir_all(parent)
crates/slskr/src/lib.rs:91569:    let mut options = fs::OpenOptions::new();
crates/slskr/src/lib.rs:91625:        fs::remove_file(&rotated_path)
crates/slskr/src/lib.rs:91628:    fs::rename(path, &rotated_path)
crates/slskr/src/lib.rs:91655:    let mut options = fs::OpenOptions::new();
crates/slskr/src/lib.rs:91735:    fs::create_dir_all(parent)?;
crates/slskr/src/lib.rs:91760:        let mut file = fs::OpenOptions::new()
crates/slskr/src/lib.rs:91771:            let _ = fs::remove_file(temp_path);
crates/slskr/src/lib.rs:91789:    fs::rename(source, destination)
crates/slskr/src/lib.rs:91797:    match fs::remove_file(destination) {
crates/slskr/src/lib.rs:91802:    fs::rename(source, destination)
crates/slskr/src/lib.rs:91832:    let mut options = fs::OpenOptions::new();
...
crates/slskr/src/controller_tests.rs:19448:    std::fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:19663:    std::fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:20036:    std::fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:20253:    std::fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:20596:    std::fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:20678:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:21116:    let _ = std::fs::remove_file(path);
crates/slskr/src/controller_tests.rs:21215:    std::fs::create_dir_all(parent).expect("download parent dir");
crates/slskr/src/controller_tests.rs:21225:    let _ = std::fs::remove_dir_all(state_dir);
crates/slskr/src/controller_tests.rs:21244:    std::fs::create_dir_all(&root).expect("download root");
crates/slskr/src/controller_tests.rs:21245:    std::fs::create_dir_all(&outside).expect("outside directory");
crates/slskr/src/controller_tests.rs:21252:    let _ = std::fs::remove_dir_all(state_dir);
crates/slskr/src/controller_tests.rs:21271:    std::fs::create_dir_all(&root).expect("download root");
crates/slskr/src/controller_tests.rs:21272:    std::fs::create_dir_all(&outside).expect("outside directory");
crates/slskr/src/controller_tests.rs:21281:    let _ = std::fs::remove_dir_all(state_dir);
crates/slskr/src/controller_tests.rs:21299:    std::fs::create_dir_all(&dir).expect("test dir");
crates/slskr/src/controller_tests.rs:21305:    std::fs::remove_file(&shared_path).expect("remove shared file");
crates/slskr/src/controller_tests.rs:21315:    let _ = std::fs::remove_dir_all(dir);
crates/slskr/src/controller_tests.rs:21336:    std::fs::create_dir_all(&root).unwrap();
crates/slskr/src/controller_tests.rs:21337:    std::fs::create_dir_all(&outside).unwrap();
crates/slskr/src/controller_tests.rs:21348:    let _ = std::fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:21349:    let _ = std::fs::remove_dir_all(outside);
crates/slskr/src/controller_tests.rs:21388:    let _ = std::fs::remove_file(path);
crates/slskr/src/controller_tests.rs:21711:    let _ = std::fs::remove_file(path);
crates/slskr/src/controller_tests.rs:21731:    std::fs::create_dir_all(path.parent().unwrap()).expect("download dir");
crates/slskr/src/controller_tests.rs:21817:    let _ = std::fs::remove_file(path);
crates/slskr/src/controller_tests.rs:21891:    let _ = std::fs::remove_file(path);
crates/slskr/src/controller_tests.rs:21982:    let _ = std::fs::remove_file(path);
crates/slskr/src/controller_tests.rs:22087:    let _ = std::fs::remove_file(path);
crates/slskr/src/controller_tests.rs:22190:    let _ = std::fs::remove_file(path);
crates/slskr/src/controller_tests.rs:22281:    let _ = std::fs::remove_file(path);
crates/slskr/src/controller_tests.rs:22431:    let _ = std::fs::remove_file(path);
crates/slskr/src/controller_tests.rs:26509:    std::fs::create_dir_all(&root).expect("create stream share root");
crates/slskr/src/controller_tests.rs:26577:    std::fs::remove_dir_all(root).expect("remove stream fixture");
crates/slskr/src/controller_tests.rs:26612:    std::fs::create_dir_all(&root).expect("create preview share root");
crates/slskr/src/controller_tests.rs:26676:    std::fs::remove_dir_all(root).expect("remove preview fixture");
crates/slskr/src/controller_tests.rs:26992:    std::fs::create_dir_all(&root).expect("trusted mesh preview root");
crates/slskr/src/controller_tests.rs:27080:    std::fs::remove_file(cleanup).expect("remove trusted preview staging file");
crates/slskr/src/controller_tests.rs:27083:    let _ = std::fs::remove_dir_all(&remote_state.config.state_dir);
crates/slskr/src/controller_tests.rs:27084:    let _ = std::fs::remove_dir_all(&local_state.config.state_dir);
crates/slskr/src/controller_tests.rs:27085:    let _ = std::fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:27256:    std::fs::create_dir_all(&child).unwrap();
crates/slskr/src/controller_tests.rs:27282:        std::fs::create_dir_all(&outside).unwrap();
crates/slskr/src/controller_tests.rs:27289:        std::fs::remove_dir_all(outside).unwrap();
crates/slskr/src/controller_tests.rs:27292:    std::fs::remove_dir_all(root).unwrap();
crates/slskr/src/controller_tests.rs:27440:    let _ = std::fs::remove_file(&queue.state_path);
crates/slskr/src/controller_tests.rs:27441:    let _ = std::fs::remove_file(&queue.events_path);
crates/slskr/src/controller_tests.rs:27913:    fs::create_dir_all(&root).expect("create overlay search state directory");
crates/slskr/src/controller_tests.rs:28038:    fs::create_dir_all(&evidence_dir).expect("create overlay protocol evidence directory");
crates/slskr/src/controller_tests.rs:28048:    let _ = fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:28169:    fs::create_dir_all(&root).expect("create mesh-sync fixture directory");
crates/slskr/src/controller_tests.rs:28416:    fs::create_dir_all(&evidence_dir).expect("create mesh-sync evidence directory");
crates/slskr/src/controller_tests.rs:28422:    let _ = fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:28721:    fs::create_dir_all(&evidence_dir).expect("create protocol evidence directory");
crates/slskr/src/controller_tests.rs:28956:    fs::create_dir_all(&evidence_dir).expect("create protocol evidence directory");
crates/slskr/src/controller_tests.rs:29132:    fs::create_dir_all(&evidence_dir).expect("create bridge dispatch evidence directory");
crates/slskr/src/controller_tests.rs:29275:    fs::create_dir_all(&evidence_dir).expect("create bridge malformed evidence directory");
crates/slskr/src/controller_tests.rs:29724:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:29900:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:31491:    fs::create_dir_all(&config.downloads_dir).unwrap();
crates/slskr/src/controller_tests.rs:31500:    fs::create_dir_all(&outside_dir).unwrap();
crates/slskr/src/controller_tests.rs:31511:    fs::remove_dir_all(state_dir).unwrap();
crates/slskr/src/controller_tests.rs:31555:    let _ = fs::remove_file(source);
crates/slskr/src/controller_tests.rs:32018:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:32164:    fs::create_dir_all(&root).expect("create mesh controller fixture directory");
crates/slskr/src/controller_tests.rs:32441:    fs::create_dir_all(&evidence_dir).expect("create mesh controller evidence directory");
crates/slskr/src/controller_tests.rs:32502:    fs::remove_dir_all(state_dir).expect("remove mesh message test state directory");
crates/slskr/src/controller_tests.rs:32503:    fs::remove_dir_all(root).expect("remove mesh controller fixture directory");
crates/slskr/src/controller_tests.rs:32838:    fs::create_dir_all(&evidence_dir).expect("create mesh edge-case evidence directory");
crates/slskr/src/controller_tests.rs:33092:    fs::create_dir_all(&evidence_dir).expect("create mesh runtime evidence directory");
crates/slskr/src/controller_tests.rs:33332:    fs::create_dir_all(&evidence_dir).expect("create mesh merge/publish evidence directory");
crates/slskr/src/controller_tests.rs:33344:    fs::remove_dir_all(state_dir).expect("remove mesh merge/publish test state directory");
crates/slskr/src/controller_tests.rs:33447:    fs::create_dir_all(&evidence_dir).expect("create mesh sync evidence directory");
crates/slskr/src/controller_tests.rs:34333:    std::fs::create_dir_all(&root).expect("create listening-party share root");
crates/slskr/src/controller_tests.rs:34424:    std::fs::remove_dir_all(root).expect("remove listening-party fixture");
crates/slskr/src/controller_tests.rs:35033:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:35217:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:35348:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:35660:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:35812:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:36015:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:36556:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:39190:    std::fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:39271:    std::fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:39446:    std::fs::create_dir_all(&root).expect("mesh gateway state directory");
crates/slskr/src/controller_tests.rs:39474:    std::fs::remove_dir_all(root).expect("remove mesh gateway state directory");
crates/slskr/src/controller_tests.rs:40767:    std::fs::create_dir_all(&root).unwrap();
crates/slskr/src/controller_tests.rs:40778:    std::fs::remove_dir_all(root).unwrap();
crates/slskr/src/controller_tests.rs:42085:    std::fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:42975:    fs::create_dir_all(root.join("Relay")).expect("relay download root");
crates/slskr/src/controller_tests.rs:43024:    let _ = fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:43188:    let _ = fs::remove_file(database_source);
crates/slskr/src/controller_tests.rs:43294:        let _ = fs::remove_file(path);
crates/slskr/src/controller_tests.rs:43297:    let _ = fs::remove_file(source);
crates/slskr/src/controller_tests.rs:43901:    std::fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:44200:    std::fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:45810:    std::fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:45914:    std::fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:47138:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:47286:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:47476:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:47692:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:47893:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:48150:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:48443:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:49164:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:49476:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:49861:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:50070:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:50110:        std::fs::create_dir_all(&state_dir).expect("state dir");
crates/slskr/src/controller_tests.rs:50175:        let _ = std::fs::remove_dir_all(state_dir);
crates/slskr/src/controller_tests.rs:50181:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:50514:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:50701:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:51075:    fs::create_dir_all(&evidence_dir).expect("create persistence evidence directory");
crates/slskr/src/controller_tests.rs:51324:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:51787:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:52843:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:53103:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:53249:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:54010:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:54299:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:54475:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:54649:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:54715:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:54797:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:54866:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:55141:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:55472:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:55939:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:56320:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:56426:        fs::remove_file(&pods_path).expect("remove channel create state file");
crates/slskr/src/controller_tests.rs:56452:        fs::remove_dir(&pods_path).expect("remove blocked channel create state path");
crates/slskr/src/controller_tests.rs:56539:        fs::remove_file(&pods_path).expect("remove channel update state file");
crates/slskr/src/controller_tests.rs:56572:        fs::remove_dir(&pods_path).expect("remove blocked channel update state path");
crates/slskr/src/controller_tests.rs:56660:        fs::remove_file(&pods_path).expect("remove channel delete state file");
crates/slskr/src/controller_tests.rs:56686:        fs::remove_dir(&pods_path).expect("remove blocked channel delete state path");
crates/slskr/src/controller_tests.rs:56764:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:56954:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:57193:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:57332:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:57523:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:57722:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:57818:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:58114:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:58656:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:59045:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:59389:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:59830:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:60155:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:60422:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:60541:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:60684:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:61452:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:61689:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:61916:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:62104:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:62197:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:62347:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:62530:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:62811:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:63261:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:63407:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:63584:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:63840:    fs::create_dir_all(&evidence_dir).expect("create ActivityPub open-case evidence directory");
crates/slskr/src/controller_tests.rs:63974:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:64398:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:64595:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:64969:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:65114:    fs::create_dir_all(&evidence_dir).expect("create discovery graph edge evidence directory");
crates/slskr/src/controller_tests.rs:65395:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:65640:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:66140:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:66515:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:66843:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:67425:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:67740:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:67968:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:68159:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:68532:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:68968:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:69421:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:70246:    fs::create_dir_all(&evidence_dir).expect("create quarantine-jury evidence directory");
crates/slskr/src/controller_tests.rs:70485:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:71019:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:71624:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:71905:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:72531:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:72881:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:73322:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:73658:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:73769:            fs::remove_file(&path).expect("remove message storage file");
crates/slskr/src/controller_tests.rs:73933:        fs::remove_dir(&messages_path).expect("remove blocked global message path");
crates/slskr/src/controller_tests.rs:74085:        fs::remove_dir(&messages_path).expect("remove blocked channel message path");
crates/slskr/src/controller_tests.rs:74111:        fs::remove_dir(&messages_path).expect("remove blocked stats message path");
crates/slskr/src/controller_tests.rs:74142:        fs::remove_dir(&messages_path).expect("remove blocked search message path");
crates/slskr/src/controller_tests.rs:74193:        fs::remove_dir(&messages_path).expect("remove blocked count message path");
crates/slskr/src/controller_tests.rs:74330:            fs::remove_dir(&messages_path).expect("remove blocked maintenance path");
crates/slskr/src/controller_tests.rs:74337:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:74440:            fs::remove_file(&path).expect("remove membership storage file");
crates/slskr/src/controller_tests.rs:74483:        fs::remove_dir(&pods_path).expect("remove blocked membership delete path");
crates/slskr/src/controller_tests.rs:74572:        fs::remove_dir(&pods_path).expect("remove blocked membership projection path");
crates/slskr/src/controller_tests.rs:74591:        fs::remove_dir(&pods_path).expect("remove blocked membership stats path");
crates/slskr/src/controller_tests.rs:74644:        fs::remove_dir(&pods_path).expect("remove blocked membership moderation path");
crates/slskr/src/controller_tests.rs:74739:        fs::remove_dir(&pods_path).expect("remove blocked membership publish path");
crates/slskr/src/controller_tests.rs:74823:        fs::remove_dir(&pods_path).expect("remove blocked membership update path");
crates/slskr/src/controller_tests.rs:74906:        fs::remove_dir(&pods_path).expect("remove blocked membership cleanup path");
crates/slskr/src/controller_tests.rs:74935:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:75003:                fs::remove_file(&path).expect("remove discovery feature state file");
crates/slskr/src/controller_tests.rs:75112:        fs::remove_dir(&feature_path).expect("remove blocked discovery registration path");
crates/slskr/src/controller_tests.rs:75200:        fs::remove_dir(&feature_path).expect("remove blocked discovery update path");
crates/slskr/src/controller_tests.rs:75313:        fs::remove_dir(&feature_path).expect("remove blocked discovery unregister path");
crates/slskr/src/controller_tests.rs:75445:        fs::remove_dir(&feature_path).expect("remove blocked discovery projection path");
crates/slskr/src/controller_tests.rs:75505:        fs::remove_dir(&feature_path).expect("remove blocked discovery refresh path");
crates/slskr/src/controller_tests.rs:75594:    fs::create_dir_all(&evidence_dir).expect("create discovery evidence directory");
crates/slskr/src/controller_tests.rs:76414:    fs::create_dir_all(&evidence_dir).expect("create PodJoinLeave evidence directory");
crates/slskr/src/controller_tests.rs:76885:    fs::create_dir_all(&evidence_dir).expect("create security ban evidence directory");
crates/slskr/src/controller_tests.rs:77332:    fs::create_dir_all(&evidence_dir).expect("create security diagnostics evidence directory");
crates/slskr/src/controller_tests.rs:78192:    fs::create_dir_all(&evidence_dir).expect("create SoulseekDiscovery evidence directory");
crates/slskr/src/controller_tests.rs:78904:    fs::create_dir_all(&evidence_dir).expect("create MultiSource evidence directory");
crates/slskr/src/controller_tests.rs:79319:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:79461:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:79717:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:79932:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:80197:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:80424:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:80455:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:81509:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:81768:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:82585:    fs::create_dir_all(&evidence_dir).expect("create discovery evidence directory");
crates/slskr/src/controller_tests.rs:83329:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:83633:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:83893:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:84194:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:84399:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:84605:                    fs::create_dir_all(&evidence_dir)
crates/slskr/src/controller_tests.rs:84698:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:84816:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:85024:    let _ = fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:85029:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:85149:    std::fs::create_dir_all(&root).expect("mesh gateway differential state directory");
crates/slskr/src/controller_tests.rs:85336:    std::fs::remove_dir_all(root).expect("remove mesh gateway differential state directory");
crates/slskr/src/controller_tests.rs:85341:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:85531:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:85875:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:86124:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:86201:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:86299:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:86389:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:86609:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:86788:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:86890:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:86953:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:87023:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:87065:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:87117:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:87172:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:87495:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:87672:    let _ = fs::remove_file(&validation_path);
crates/slskr/src/controller_tests.rs:87835:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:88089:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:88221:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:88326:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:88507:    fs::create_dir_all(&evidence_dir).expect("create trace evidence directory");
crates/slskr/src/controller_tests.rs:88726:    fs::create_dir_all(&evidence_dir).expect("create compatibility evidence directory");
crates/slskr/src/controller_tests.rs:88886:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:88978:    std::fs::create_dir_all(download_file.parent().unwrap())
crates/slskr/src/controller_tests.rs:89036:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:89184:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:89270:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:89373:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:89492:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:89544:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:90067:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:90439:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:90508:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:90555:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:90605:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:90659:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:90763:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:90820:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:90881:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:90926:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:90982:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:91039:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:91156:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:91217:    fs::create_dir_all(&custom_path).expect("create destination fixture");
crates/slskr/src/controller_tests.rs:91274:    let _ = fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:91278:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:91333:    fs::create_dir_all(&root).expect("create destination edge root");
crates/slskr/src/controller_tests.rs:91567:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:91574:    let _ = fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:91814:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:92333:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:93056:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:93210:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:93450:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:93719:        std::fs::create_dir_all(&root).expect("create differential listening-party share root");
crates/slskr/src/controller_tests.rs:93774:        let _ = std::fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:93780:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:94010:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:94080:        std::fs::create_dir_all(&root).expect("create differential downloads root");
crates/slskr/src/controller_tests.rs:94111:        std::fs::create_dir_all(&root).expect("create differential recursive downloads root");
crates/slskr/src/controller_tests.rs:94162:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:94629:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:94840:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:94943:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:95427:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:95657:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:95818:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:96476:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:97013:    fs::create_dir_all(&evidence_dir).expect("create parity evidence directory");
crates/slskr/src/controller_tests.rs:97923:    fs::create_dir_all(existing.parent().unwrap()).unwrap();
crates/slskr/src/controller_tests.rs:98152:    fs::create_dir_all(&evidence_dir).expect("create file lifecycle evidence directory");
crates/slskr/src/controller_tests.rs:98643:    fs::create_dir_all(&new_root).unwrap();
crates/slskr/src/controller_tests.rs:98644:    fs::create_dir_all(&new_downloads).unwrap();
crates/slskr/src/controller_tests.rs:98645:    fs::create_dir_all(&new_incomplete).unwrap();
crates/slskr/src/controller_tests.rs:99043:    fs::create_dir_all(&evidence_dir).expect("create file lifecycle evidence directory");
crates/slskr/src/controller_tests.rs:99074:        fs::create_dir_all(download_file.parent().unwrap()).expect("downloads fixture root");
crates/slskr/src/controller_tests.rs:99075:        fs::create_dir_all(incomplete_file.parent().unwrap()).expect("incomplete fixture root");
crates/slskr/src/controller_tests.rs:99208:    fs::create_dir_all(&evidence_dir).expect("create file lifecycle evidence directory");
crates/slskr/src/controller_tests.rs:99313:    fs::create_dir_all(&evidence_dir).expect("create file lifecycle evidence directory");
crates/slskr/src/controller_tests.rs:99531:        let _ = fs::remove_dir_all(state_dir);
crates/slskr/src/controller_tests.rs:99537:    fs::create_dir_all(&evidence_dir).expect("create file lifecycle evidence directory");
crates/slskr/src/controller_tests.rs:99561:        fs::create_dir_all(&root).expect("secure writer root");
crates/slskr/src/controller_tests.rs:99625:        let _ = fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:99631:    fs::create_dir_all(&evidence_dir).expect("create file lifecycle evidence directory");
crates/slskr/src/controller_tests.rs:99653:    fs::create_dir_all(&root).expect("DHT certificate root");
crates/slskr/src/controller_tests.rs:99686:        fs::create_dir_all(&linked_root).expect("DHT symlink root");
crates/slskr/src/controller_tests.rs:99744:    fs::create_dir_all(&evidence_dir).expect("create file lifecycle evidence directory");
crates/slskr/src/controller_tests.rs:99751:    let _ = fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:100680:    std::fs::create_dir_all(&root).unwrap();
crates/slskr/src/controller_tests.rs:100705:    let _ = std::fs::remove_dir_all(&root);
crates/slskr/src/controller_tests.rs:100706:    let _ = std::fs::remove_file(&outside);
crates/slskr/src/controller_tests.rs:100731:    std::fs::create_dir_all(&root).unwrap();
crates/slskr/src/controller_tests.rs:100769:    let _ = std::fs::remove_dir_all(&root);
crates/slskr/src/controller_tests.rs:100888:    std::fs::create_dir_all(&nested).expect("create nested dir");
crates/slskr/src/controller_tests.rs:100905:    std::fs::create_dir_all(&album).expect("create recursive directory");
crates/slskr/src/controller_tests.rs:100914:    let _ = std::fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:100935:    std::fs::create_dir_all(&root).expect("create root");
crates/slskr/src/controller_tests.rs:100936:    std::fs::create_dir_all(&outside).expect("create outside");
crates/slskr/src/controller_tests.rs:100949:    let _ = std::fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:100950:    let _ = std::fs::remove_dir_all(outside);
crates/slskr/src/controller_tests.rs:100967:    std::fs::create_dir_all(&root).expect("create root");
crates/slskr/src/controller_tests.rs:100982:    let _ = std::fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:101002:    std::fs::create_dir_all(&directory).expect("create deep directory tree");
crates/slskr/src/controller_tests.rs:101012:    let _ = std::fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:101709:    std::fs::create_dir_all(&root).unwrap();
crates/slskr/src/controller_tests.rs:101716:    std::fs::remove_dir_all(root).unwrap();
crates/slskr/src/controller_tests.rs:101730:    std::fs::create_dir_all(&root).unwrap();
crates/slskr/src/controller_tests.rs:101736:    std::fs::remove_dir_all(root).unwrap();
crates/slskr/src/controller_tests.rs:101795:    std::fs::create_dir_all(&artist).unwrap();
crates/slskr/src/controller_tests.rs:101797:    std::fs::create_dir_all(root.join(".hidden")).unwrap();
crates/slskr/src/controller_tests.rs:101814:    std::fs::remove_dir_all(root).unwrap();
crates/slskr/src/controller_tests.rs:101822:    std::fs::create_dir_all(&root).unwrap();
crates/slskr/src/controller_tests.rs:101859:    std::fs::remove_dir_all(root).unwrap();
crates/slskr/src/controller_tests.rs:101869:    std::fs::create_dir_all(&first).unwrap();
crates/slskr/src/controller_tests.rs:101870:    std::fs::create_dir_all(&second).unwrap();
crates/slskr/src/controller_tests.rs:101883:    std::fs::remove_dir_all(root).unwrap();
crates/slskr/src/controller_tests.rs:101922:    std::fs::create_dir_all(&excluded).unwrap();
crates/slskr/src/controller_tests.rs:101943:    std::fs::remove_dir_all(root).unwrap();
crates/slskr/src/controller_tests.rs:101967:    std::fs::create_dir_all(&root).unwrap();
crates/slskr/src/controller_tests.rs:101980:    std::fs::remove_dir_all(root).unwrap();
crates/slskr/src/controller_tests.rs:102001:    std::fs::create_dir_all(&root).unwrap();
crates/slskr/src/controller_tests.rs:102002:    std::fs::create_dir_all(&outside).unwrap();
crates/slskr/src/controller_tests.rs:102016:    let _ = std::fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:102017:    let _ = std::fs::remove_dir_all(outside);
crates/slskr/src/controller_tests.rs:102056:    std::fs::create_dir_all(&state_dir).unwrap();
crates/slskr/src/controller_tests.rs:102076:    std::fs::remove_dir_all(state_dir).unwrap();
crates/slskr/src/controller_tests.rs:102092:    let _ = std::fs::remove_file(queue.events_path);
crates/slskr/src/controller_tests.rs:102374:    let _ = std::fs::remove_file(queue.events_path);
crates/slskr/src/controller_tests.rs:102375:    let _ = std::fs::remove_file(queue.state_path);
crates/slskr/src/controller_tests.rs:102882:    std::fs::create_dir_all(partial_path.parent().unwrap()).expect("create download root");
crates/slskr/src/controller_tests.rs:102956:    std::fs::remove_dir_all(&state.config.state_dir).expect("remove test state directory");
crates/slskr/src/controller_tests.rs:102995:    let _ = std::fs::remove_file(&path);
crates/slskr/src/controller_tests.rs:102996:    let mut file = std::fs::OpenOptions::new()
crates/slskr/src/controller_tests.rs:103013:    std::fs::remove_file(path).expect("remove cancelled transfer test file");
...
crates/slskr/src/controller_tests.rs:103093:    let _ = std::fs::remove_file(queue.events_path);
crates/slskr/src/controller_tests.rs:103094:    let _ = std::fs::remove_file(queue.state_path);
crates/slskr/src/controller_tests.rs:103113:    let _ = std::fs::remove_file(queue.events_path);
crates/slskr/src/controller_tests.rs:103114:    let _ = std::fs::remove_file(queue.state_path);
crates/slskr/src/controller_tests.rs:103163:    let _ = std::fs::remove_file(queue.events_path);
crates/slskr/src/controller_tests.rs:103164:    let _ = std::fs::remove_file(queue.state_path);
crates/slskr/src/controller_tests.rs:103227:    let _ = std::fs::remove_file(queue.events_path);
crates/slskr/src/controller_tests.rs:103228:    let _ = std::fs::remove_file(queue.state_path);
crates/slskr/src/controller_tests.rs:103280:    let _ = std::fs::remove_file(queue.events_path);
crates/slskr/src/controller_tests.rs:103281:    let _ = std::fs::remove_file(queue.state_path);
crates/slskr/src/controller_tests.rs:103344:    let _ = std::fs::remove_file(queue.events_path);
crates/slskr/src/controller_tests.rs:103345:    let _ = std::fs::remove_file(queue.state_path);
crates/slskr/src/controller_tests.rs:103359:    std::fs::create_dir_all(&state_dir).expect("state dir");
crates/slskr/src/controller_tests.rs:103396:    let _ = std::fs::remove_dir_all(state_dir);
crates/slskr/src/controller_tests.rs:103410:    std::fs::create_dir_all(&state_dir).expect("state dir");
crates/slskr/src/controller_tests.rs:103477:    let _ = std::fs::remove_dir_all(state_dir);
crates/slskr/src/controller_tests.rs:103522:    std::fs::create_dir_all(&state_dir).expect("state dir");
crates/slskr/src/controller_tests.rs:103533:    let _ = std::fs::remove_dir_all(state_dir);
crates/slskr/src/controller_tests.rs:103548:    std::fs::create_dir_all(&state_dir).expect("state dir");
crates/slskr/src/controller_tests.rs:103560:    let _ = std::fs::remove_dir_all(state_dir);
crates/slskr/src/controller_tests.rs:103577:    std::fs::create_dir_all(&state_dir).expect("state dir");
crates/slskr/src/controller_tests.rs:103644:    let _ = std::fs::remove_dir_all(state_dir);
crates/slskr/src/controller_tests.rs:103658:    std::fs::create_dir_all(&state_dir).expect("state dir");
crates/slskr/src/controller_tests.rs:103671:    let _ = std::fs::remove_dir_all(state_dir);
crates/slskr/src/controller_tests.rs:103685:    fs::create_dir_all(&state_dir).expect("file lifecycle state dir");
crates/slskr/src/controller_tests.rs:103794:    fs::create_dir_all(&evidence_dir).expect("create file lifecycle evidence directory");
crates/slskr/src/controller_tests.rs:103801:    let _ = fs::remove_dir_all(state_dir);
crates/slskr/src/controller_tests.rs:103816:    std::fs::create_dir_all(&state_dir).expect("state dir");
crates/slskr/src/controller_tests.rs:103828:    let _ = std::fs::remove_dir_all(state_dir);
crates/slskr/src/controller_tests.rs:103842:    std::fs::create_dir_all(&state_dir).expect("state dir");
crates/slskr/src/controller_tests.rs:103898:    let _ = std::fs::remove_dir_all(state_dir);
crates/slskr/src/controller_tests.rs:103931:    std::fs::create_dir_all(&state_dir).unwrap();
crates/slskr/src/controller_tests.rs:103940:    let _ = std::fs::remove_dir_all(state_dir);
crates/slskr/src/controller_tests.rs:104497:    std::fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:104932:    let _ = fs::remove_file(conflict_root);
crates/slskr/src/controller_tests.rs:104937:    fs::create_dir_all(&evidence_dir).expect("create source-feed evidence directory");
crates/slskr/src/controller_tests.rs:105108:    std::fs::remove_file(picture).unwrap();
crates/slskr/src/controller_tests.rs:105301:    std::fs::create_dir_all(downloads_root.join("Artist/Album")).unwrap();
crates/slskr/src/controller_tests.rs:105303:    std::fs::create_dir_all(incomplete_root.join("Partial")).unwrap();
crates/slskr/src/controller_tests.rs:105398:        std::fs::create_dir_all(file_path.parent().unwrap()).unwrap();
crates/slskr/src/controller_tests.rs:105664:        fs::create_dir_all(&downloads_target).expect("create downloads list target");
crates/slskr/src/controller_tests.rs:105665:        fs::create_dir_all(&incomplete_target).expect("create incomplete list target");
crates/slskr/src/controller_tests.rs:105700:        let _ = fs::remove_file(downloads_link);
crates/slskr/src/controller_tests.rs:105701:        let _ = fs::remove_file(incomplete_link);
crates/slskr/src/controller_tests.rs:105702:        let _ = fs::remove_dir_all(downloads_target);
crates/slskr/src/controller_tests.rs:105703:        let _ = fs::remove_dir_all(incomplete_target);
crates/slskr/src/controller_tests.rs:105705:    let _ = fs::remove_file(downloads_conflict_root);
crates/slskr/src/controller_tests.rs:105706:    let _ = fs::remove_file(incomplete_conflict_root);
crates/slskr/src/controller_tests.rs:105959:    std::fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:106001:    std::fs::create_dir_all(incomplete_root.join("Nested")).unwrap();
crates/slskr/src/controller_tests.rs:106253:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:106524:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:106604:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:106938:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:106978:    let _ = std::fs::remove_dir_all(&file_state.config.downloads_dir);
crates/slskr/src/controller_tests.rs:106979:    let _ = std::fs::remove_dir_all(&file_state.config.incomplete_dir);
crates/slskr/src/controller_tests.rs:107245:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:107333:    fs::create_dir_all(downloads_root.join("Relay")).expect("relay download root");
crates/slskr/src/controller_tests.rs:107372:    fs::remove_file(downloads_root.join("Relay/Agent.txt"))
crates/slskr/src/controller_tests.rs:107506:    fs::remove_dir_all(&incoming_directory).expect("remove relay upload directory");
crates/slskr/src/controller_tests.rs:107549:    fs::remove_file(&incoming_directory).expect("remove relay upload conflict");
crates/slskr/src/controller_tests.rs:107550:    fs::create_dir_all(&incoming_directory).expect("restore relay upload directory");
crates/slskr/src/controller_tests.rs:107675:    fs::remove_dir_all(&incoming_directory).expect("remove relay share upload directory");
crates/slskr/src/controller_tests.rs:107717:    fs::remove_file(&incoming_directory).expect("remove relay share upload conflict");
crates/slskr/src/controller_tests.rs:107718:    fs::create_dir_all(&incoming_directory).expect("restore relay share upload directory");
crates/slskr/src/controller_tests.rs:107719:    let _ = fs::remove_file(database_source);
crates/slskr/src/controller_tests.rs:107720:    let _ = fs::remove_dir_all(downloads_root);
crates/slskr/src/controller_tests.rs:107725:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:108673:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:108997:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:109336:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:109805:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:110550:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:110785:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:111073:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:111497:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:111746:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:112654:    fs::create_dir_all(&evidence_dir).expect("create searches evidence directory");
crates/slskr/src/controller_tests.rs:112912:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:113222:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:113750:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:114029:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:114428:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:114849:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:115227:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:115438:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:115730:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:116159:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:116405:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:116679:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:117198:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:117418:    fs::create_dir_all(&evidence_dir).expect("create runtime security evidence directory");
crates/slskr/src/controller_tests.rs:117467:        fs::create_dir_all(&root).expect("path guard root");
crates/slskr/src/controller_tests.rs:117555:        let _ = fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:117637:    fs::create_dir_all(&evidence_dir).expect("create path guard security evidence directory");
crates/slskr/src/controller_tests.rs:117740:    fs::create_dir_all(&evidence_dir).expect("create share token security evidence directory");
crates/slskr/src/controller_tests.rs:117903:    fs::create_dir_all(&evidence_dir).expect("create CSRF security evidence directory");
crates/slskr/src/controller_tests.rs:118032:    fs::create_dir_all(&hash_root).expect("hardening hash config directory");
crates/slskr/src/controller_tests.rs:118046:    fs::remove_dir_all(&hash_root).expect("remove hardening hash config directory");
crates/slskr/src/controller_tests.rs:118094:    fs::create_dir_all(&evidence_dir).expect("create hardening security evidence directory");
crates/slskr/src/controller_tests.rs:118141:    fs::create_dir_all(&root).expect("certificate manager root");
crates/slskr/src/controller_tests.rs:118200:    fs::create_dir_all(&incomplete_root).expect("incomplete certificate root");
crates/slskr/src/controller_tests.rs:118217:    fs::create_dir_all(&oversized_root).expect("oversized certificate root");
crates/slskr/src/controller_tests.rs:118240:        fs::create_dir_all(&symlink_root).expect("symlink certificate root");
crates/slskr/src/controller_tests.rs:118305:    fs::create_dir_all(&evidence_dir).expect("create certificate security evidence directory");
crates/slskr/src/controller_tests.rs:118312:    fs::remove_dir_all(&root).expect("remove certificate manager root");
crates/slskr/src/controller_tests.rs:118480:    fs::create_dir_all(&evidence_dir).expect("create overlay validation evidence directory");
crates/slskr/src/controller_tests.rs:118626:    fs::create_dir_all(&evidence_dir).expect("create Solid policy security evidence directory");
crates/slskr/src/controller_tests.rs:118993:    fs::create_dir_all(&certificate_root).expect("certificate root");
crates/slskr/src/controller_tests.rs:119022:    fs::create_dir_all(&malformed_root).expect("malformed certificate root");
crates/slskr/src/controller_tests.rs:119051:    let _ = fs::remove_dir_all(&certificate_root);
crates/slskr/src/controller_tests.rs:119052:    let _ = fs::remove_dir_all(&malformed_root);
crates/slskr/src/controller_tests.rs:119057:    fs::create_dir_all(&evidence_dir).expect("create security-controls evidence directory");
crates/slskr/src/controller_tests.rs:119111:    fs::create_dir_all(&root).expect("content-safety root");
crates/slskr/src/controller_tests.rs:119190:    let _ = fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:119194:    fs::create_dir_all(&evidence_dir).expect("create content-safety evidence directory");
crates/slskr/src/controller_tests.rs:119313:    fs::create_dir_all(&evidence_dir).expect("create Soulseek safety evidence directory");
crates/slskr/src/controller_tests.rs:119437:    fs::create_dir_all(&evidence_dir).expect("create security event sink evidence directory");
crates/slskr/src/controller_tests.rs:119983:    std::fs::create_dir_all(&evidence_dir).expect("create integrity evidence directory");
crates/slskr/src/controller_tests.rs:120662:    std::fs::create_dir_all(&evidence_dir).expect("create runtime-control evidence directory");
crates/slskr/src/controller_tests.rs:120872:    std::fs::create_dir_all(&evidence_dir).expect("create route-security evidence directory");
crates/slskr/src/controller_tests.rs:121271:    let _ = fs::remove_dir_all(&root);
crates/slskr/src/controller_tests.rs:121569:    fs::create_dir_all(&evidence_dir).expect("create security-controls evidence directory");
crates/slskr/src/controller_tests.rs:121748:    fs::create_dir_all(&root).expect("JWT revocation root");
crates/slskr/src/controller_tests.rs:121800:    let _ = fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:121805:    fs::create_dir_all(&evidence_dir).expect("create security-controls evidence directory");
crates/slskr/src/controller_tests.rs:121926:    fs::create_dir_all(&evidence_dir).expect("create security controller evidence directory");
crates/slskr/src/controller_tests.rs:122010:    fs::create_dir_all(&evidence_dir).expect("create passthrough security evidence directory");
crates/slskr/src/controller_tests.rs:122065:        fs::create_dir_all(&root).expect("authentication control state root");
crates/slskr/src/controller_tests.rs:122224:        let _ = fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:122230:    fs::create_dir_all(&evidence_dir)
crates/slskr/src/controller_tests.rs:122278:    fs::create_dir_all(&root).expect("pin file lifecycle root");
crates/slskr/src/controller_tests.rs:122320:        fs::create_dir_all(attack_root.join("mesh")).expect("symlink attack directory");
crates/slskr/src/controller_tests.rs:122344:    fs::create_dir_all(&evidence_dir).expect("create file-lifecycle evidence directory");
crates/slskr/src/controller_tests.rs:122351:    let _ = fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:122370:    fs::create_dir_all(&root).expect("Gold Star file lifecycle root");
crates/slskr/src/controller_tests.rs:122417:        fs::create_dir_all(&linked_root).expect("Gold Star linked state directory");
crates/slskr/src/controller_tests.rs:122441:    fs::create_dir_all(&evidence_dir).expect("create file-lifecycle evidence directory");
crates/slskr/src/controller_tests.rs:122448:    let _ = fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:122593:    fs::create_dir_all(&root).expect("create multisource lifecycle root");
crates/slskr/src/controller_tests.rs:122869:    fs::create_dir_all(&evidence_dir).expect("create multisource evidence directory");
crates/slskr/src/controller_tests.rs:122878:    let _ = fs::remove_dir_all(root);
crates/slskr/src/controller_tests.rs:123123:        let _ = fs::remove_file(yaml_failure_root);
crates/slskr/src/controller_tests.rs:123295:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:123760:    let _ = fs::remove_file(conflict_root);
crates/slskr/src/controller_tests.rs:124305:    fs::create_dir_all(&evidence_dir).expect("create controller-api evidence directory");
crates/slskr/src/controller_tests.rs:124483:    let _ = fs::remove_file(&restart_path);
crates/slskr/src/controller_tests.rs:124553:    fs::create_dir_all(&evidence_dir).expect("create persistence evidence directory");
crates/slskr/src/controller_tests.rs:124711:    let _ = fs::remove_file(&restart_path);
crates/slskr/src/controller_tests.rs:124766:    fs::create_dir_all(&evidence_dir).expect("create persistence evidence directory");
crates/slskr/src/controller_tests.rs:124927:        let _ = std::fs::remove_file(&restart_path);
crates/slskr/src/controller_tests.rs:124977:    fs::create_dir_all(&evidence_dir).expect("create persistence evidence directory");
crates/slskr/src/controller_tests.rs:125220:    let _ = fs::remove_file(&restart_path);
crates/slskr/src/controller_tests.rs:125358:    fs::create_dir_all(&evidence_dir).expect("create persistence evidence directory");
crates/slskr/src/controller_tests.rs:125502:    let _ = fs::remove_file(&restart_path);
crates/slskr/src/controller_tests.rs:125559:    fs::create_dir_all(&evidence_dir).expect("create SongID persistence evidence directory");
crates/slskr/src/controller_tests.rs:125665:    let _ = fs::remove_file(&restart_path);
crates/slskr/src/controller_tests.rs:125703:    fs::create_dir_all(&evidence_dir).expect("create TrafficStats evidence directory");
crates/slskr/src/controller_tests.rs:126327:    fs::create_dir_all(&evidence_dir).expect("create HashDb controller evidence directory");
crates/slskr/src/controller_tests.rs:126423:            fs::remove_file(&path).expect("remove state file before runtime failure");
crates/slskr/src/controller_tests.rs:127640:    fs::create_dir_all(&evidence_dir).expect("create PodsController evidence directory");
crates/slskr/src/controller_tests.rs:128917:    fs::create_dir_all(&evidence_dir).expect("create WishlistController evidence directory");
crates/slskr/src/controller_tests.rs:129265:    fs::create_dir_all(&evidence_dir)
crates/slskr/src/controller_tests.rs:130268:    fs::create_dir_all(&evidence_dir).expect("create RoomsController evidence directory");
crates/slskr/src/controller_tests.rs:131005:    fs::create_dir_all(&evidence_dir).expect("create BridgeController evidence directory");
crates/slskr/src/controller_tests.rs:131078:            fs::remove_file(&path).expect("remove PodCore state file before blocking it");
crates/slskr/src/controller_tests.rs:131095:                fs::remove_dir_all(&path).expect("remove prepared PodCore feature directory");
crates/slskr/src/controller_tests.rs:131097:                fs::remove_file(&path).expect("remove prepared PodCore feature file");
crates/slskr/src/controller_tests.rs:133163:    fs::create_dir_all(&evidence_dir).expect("create PodCore evidence directory");
crates/slskr/src/controller_tests.rs:133582:        fs::create_dir_all(&state_dir).expect("create MediaCore residual state directory");
crates/slskr/src/controller_tests.rs:133624:        let _ = fs::remove_dir_all(&state_dir);
crates/slskr/src/controller_tests.rs:133647:    fs::create_dir_all(&evidence_dir).expect("create MediaCore evidence directory");
crates/slskr/src/controller_tests.rs:134441:    fs::create_dir_all(&evidence_dir).expect("create MusicBrainz evidence directory");
crates/slskr/src/controller_tests.rs:134990:    fs::create_dir_all(&evidence_dir).expect("create Jobs evidence directory");
crates/slskr/src/controller_tests.rs:135135:    fs::create_dir_all(&item_root).expect("create residual library directory");
crates/slskr/src/controller_tests.rs:135249:    let _ = fs::remove_dir_all(&item_root);
crates/slskr/src/controller_tests.rs:135491:    fs::create_dir_all(&evidence_dir).expect("create Library evidence directory");
crates/slskr/src/controller_tests.rs:136422:    fs::create_dir_all(&evidence_dir).expect("create Security evidence directory");
crates/slskr/src/controller_tests.rs:136983:        fs::create_dir_all(&connection_path).expect("create Spotify connection conflict");
crates/slskr/src/controller_tests.rs:137441:    fs::create_dir_all(&evidence_dir).expect("create Integrations evidence directory");
crates/slskr/src/controller_tests.rs:138201:    fs::create_dir_all(&evidence_dir).expect("create Backfill evidence directory");
crates/slskr/src/controller_tests.rs:138894:    fs::create_dir_all(&evidence_dir).expect("create slskdn native evidence directory");
crates/slskr/src/controller_tests.rs:139267:    fs::create_dir_all(&evidence_dir).expect("create audio evidence directory");
crates/slskr/src/controller_tests.rs:139630:    fs::create_dir_all(&evidence_dir).expect("create taste recommendation evidence directory");
crates/slskr/src/controller_tests.rs:140118:    fs::create_dir_all(&evidence_dir).expect("create SongID evidence directory");
crates/slskr/src/controller_tests.rs:140660:    fs::create_dir_all(&evidence_dir).expect("create share-grants evidence directory");
crates/slskr/src/controller_tests.rs:141105:    fs::create_dir_all(&evidence_dir).expect("create shares evidence directory");
crates/slskr/src/controller_tests.rs:141716:    fs::create_dir_all(&evidence_dir).expect("create users evidence directory");
crates/slskr/src/controller_tests.rs:142128:    fs::create_dir_all(&evidence_dir).expect("create telemetry evidence directory");
crates/slskr/src/controller_tests.rs:142415:    fs::create_dir_all(downloads_root.join("Relay")).expect("relay download directory");
crates/slskr/src/controller_tests.rs:142947:    let _ = fs::remove_dir_all(super::effective_downloads_dir(&controller_state));
crates/slskr/src/controller_tests.rs:142948:    let _ = fs::remove_file(share_source);
crates/slskr/src/controller_tests.rs:142953:    fs::create_dir_all(&evidence_dir).expect("create relay evidence directory");
crates/slskr/src/controller_tests.rs:143700:    fs::create_dir_all(&evidence_dir).expect("create conversations evidence directory");
crates/slskr/src/controller_tests.rs:144385:    fs::create_dir_all(&evidence_dir).expect("create downloads evidence directory");
crates/slskr/src/controller_tests.rs:144500:            fs::create_dir_all(&path).expect("create nominal directory");
crates/slskr/src/controller_tests.rs:144563:            fs::create_dir_all(&path).expect("create mutation directory");
crates/slskr/src/controller_tests.rs:144597:            fs::create_dir_all(&path).expect("create concurrent directory");
crates/slskr/src/controller_tests.rs:144635:            fs::create_dir_all(&root).expect("create file storage root");
crates/slskr/src/controller_tests.rs:144687:            fs::create_dir_all(&root).expect("create concurrent file root");
crates/slskr/src/controller_tests.rs:144735:        fs::create_dir_all(&root).expect("create incomplete mutation root");
crates/slskr/src/controller_tests.rs:144814:            fs::create_dir_all(root.join("Album")).expect("create populated root");
crates/slskr/src/controller_tests.rs:144833:            fs::create_dir_all(root.join("Album")).expect("create nominal detail root");
crates/slskr/src/controller_tests.rs:144892:            fs::create_dir_all(&album).expect("create populated detail root");
crates/slskr/src/controller_tests.rs:144918:    fs::create_dir_all(&evidence_dir).expect("create files evidence directory");
...
crates/slskr/src/lib.rs:90866:    let snapshot = tokio::task::spawn_blocking(move || build_share_index(&config))
...
crates/slskr/src/controller_tests.rs:20144:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:21413:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:21489:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:21577:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:21644:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:21751:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:21848:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:21921:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:21955:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:22022:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:22127:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:22244:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:22301:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:22407:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:22462:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:26726:    let peer = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:26859:    let source = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:27046:    let gateway_server = tokio::spawn(gateway.run(Arc::clone(&remote_state)));
crates/slskr/src/controller_tests.rs:27109:    let write = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:27848:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:27983:    let gateway_server = tokio::spawn(gateway.run(Arc::clone(&state)));
crates/slskr/src/controller_tests.rs:28125:    match tokio::time::timeout(
crates/slskr/src/controller_tests.rs:28434:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:28437:            tokio::time::timeout(Duration::from_secs(1), super::bridge_read_frame(&mut first))
crates/slskr/src/controller_tests.rs:28475:        tokio::time::timeout(
crates/slskr/src/controller_tests.rs:28492:    let reconnected = match tokio::time::timeout(
crates/slskr/src/controller_tests.rs:28524:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:28765:        let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:28798:        let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:28828:        let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:28859:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:28993:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:29167:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:29197:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:29220:        tokio::time::timeout(
crates/slskr/src/controller_tests.rs:29236:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:29260:        tokio::time::timeout(
crates/slskr/src/controller_tests.rs:29292:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:29316:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:29321:        super::bridge_read_frame_with_timeout(&mut stream, Duration::from_millis(20)).await
crates/slskr/src/controller_tests.rs:31565:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:35071:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:35246:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:43229:    let open = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:43312:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:43472:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:44558:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:44624:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:44754:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:44827:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:45831:    let task = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:50657:        writes.push(tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:50924:        pod_creates.push(tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:50959:        message_writes.push(tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:84882:    let token_server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:84894:    let profile_server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:85489:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:97201:        let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:99386:        let first_server = tokio::spawn(serve_relay_fixture(
crates/slskr/src/controller_tests.rs:99428:        let second_server = tokio::spawn(serve_relay_fixture(
crates/slskr/src/controller_tests.rs:99486:        let partial_server = tokio::spawn(serve_relay_fixture(
crates/slskr/src/controller_tests.rs:101069:    let (event_tx, _) = tokio::sync::broadcast::channel(super::EVENT_HISTORY_LIMIT);
crates/slskr/src/controller_tests.rs:103966:    let handler = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:104060:    let (request_tx, mut request_rx) = mpsc::unbounded_channel::<String>();
crates/slskr/src/controller_tests.rs:104061:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:105198:    tokio::time::timeout(Duration::from_secs(1), async {
crates/slskr/src/controller_tests.rs:105226:    assert!(tokio::time::timeout(Duration::from_secs(1), peer.receive())
crates/slskr/src/controller_tests.rs:107279:        let task = tokio::spawn(super::handle_http_stream(server, None, false, state));
crates/slskr/src/controller_tests.rs:111120:        let task = tokio::spawn(super::handle_http_stream(server, None, false, state));
crates/slskr/src/controller_tests.rs:114300:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:116452:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:118552:    let server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:122502:        let task = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:122508:                tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:122720:        let task = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:122785:    let download = tokio::spawn(super::multisource::execute(
crates/slskr/src/controller_tests.rs:122792:    let stalled = tokio::time::timeout(Duration::from_secs(5), async {
crates/slskr/src/controller_tests.rs:123423:    let version_server = tokio::spawn(async move {
crates/slskr/src/controller_tests.rs:123965:        let task = tokio::spawn(super::handle_http_stream(server, None, false, state));
crates/slskr/src/controller_tests.rs:136476:        let task = tokio::spawn(async move { serve_json_fixture(&listener, response).await });
crates/slskr/src/controller_tests.rs:142244:        let task = tokio::spawn(super::handle_http_stream(
crates/slskr/src/controller_tests.rs:142882:    let stream_task = tokio::spawn(async move { live_get(stream_state, &stream_path).await });

...
| Rust formatting | Existing Rust sources had trailing whitespace that blocked the Rust formatter. | Stripped trailing whitespace and reran the changed-file formatter check. |

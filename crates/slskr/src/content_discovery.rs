...
pub(crate) const MAX_HASH_MERGE_ENTRIES: usize = 1_000;
pub(crate) const MAX_MESH_MERGE_ENTRIES: usize = MAX_HASH_MERGE_ENTRIES * 2;
pub(crate) const MAX_MESH_FILE_SIZE: u64 = 10_000_000_000;
const MAX_SHADOW_RECORDINGS: usize = 4_096;
pub(crate) const MAX_SHADOW_MERGE_RECORDS: usize = 256;
